...
const Stories = ({data}) => {
  return (
    <>
    <Head>
        <title>ai-Artical/stories</title>
    ...
    </section>:<div className="flex mt-40 justify-center content-center"> अभी भाई कोई स्टोरी नहीं हैं</div>}
  </>
  )
}
export async function getServerSideProps() {
    ...
    let getdatas = await postBlog.find({catagory:"stories"})
