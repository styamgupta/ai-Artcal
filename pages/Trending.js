...
const Trending = ({data}) => {
  return (
    <>
    <Head>
        <title>ai-Artical/trending</title>
    ...
    </section>:<div className="flex mt-40 justify-center content-center"> अभी भाई कुछ ट्रेंडिंग नहीं है</div>}
  </>
  )
}
export async function getServerSideProps() {
    ...
    let getdatas = await postBlog.find({catagory:"trending"})
